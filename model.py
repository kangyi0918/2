...
if 'messages' not in st.session_state:
    st.session_state.messages = [{"role": "system", "content": "你是名为小新的AI助手，友好且乐于助人，能回答各类问题"}]
...
with st.sidebar:
    ...
    # 获取jpg的Base64编码
    image_base64 = get_image_base64("sdsnt.jpg")
    ...
    st.image("hx.jpg", caption="小新", use_container_width=True)
    st.title("✨ 系统设置")
